namespace ECToken.Tests.EncryptLibTests
{
    ...
    public class ECTokenGeneratorDecryptionTests
    {
        ...
        {
            //arrange
            var key = new EdgeCastKey("thisisakey");
            var encrypted = new EdgeCastToken("24JJvrIX--LTuT_BN4WTB_n_uNtl91zrGmMzcSiKODAh0FukUT-O0WaudZ4mVc4yJmYp8bGQzIqE6toLqn40GaK98xfDe0xmrgfB46OEQiNGCAErwzed3XAy5a45Z-RVduxvppoUvga17mG8W5mEafPsfU9RgVyH6eajPosJSssIeywFFybVDf4kRZod");
            //act
